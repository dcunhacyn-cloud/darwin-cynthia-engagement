...
export default function Home() {
  ...
  return (
    <main>
      <audio ref={audioRef} src="/assets/metro-proposal.mp3" loop preload="metadata" />
      ...
      <div className="ring-journey" aria-hidden="true">
        <div className="ring ring-left"><model-viewer src="/assets/darwin-ring.glb" camera-orbit="25deg 70deg 105%" auto-rotate rotation-per-second="18deg" disable-zoom /></div>
        <div className="ring ring-right"><model-viewer src="/assets/cynthia-ring.glb" camera-orbit="-25deg 70deg 105%" auto-rotate rotation-per-second="-18deg" disable-zoom /></div>
      </div>
      ...
      <section className={`cover ${opened ? "opened" : ""}`} aria-label="Invitation cover">
        ...
        <div className="cover-copy">
          ...
          <h1><span>Darwin</span><b>&</b><span>Cynthia</span></h1>
          <div className="cover-rule"><i /><span>✦</span><i /></div>
          <p className="date">26 · 09 · 2026</p>
          <p className="place">Kochi, Kerala</p>
        </div>
        {!opened && <button className="seal" onClick={openInvite}><span>D <i>&</i> C</span><small>Tap to open</small></button>}
      ...
      <section className="portrait panel">
        <figure className="portrait-frame reveal"><img src="/assets/our-sketch.png" alt="Darwin and Cynthia smiling together" loading="lazy" /></figure>
        <div className="portrait-copy reveal">
          ...
          <p className="signature">Darwin <span>&</span> Cynthia</p>
        </div>
      </section>
      ...
      <section className="countdown-section panel">
        ...
        <div className="countdown-copy reveal">
          ...
          <CountdownBlock />
          <a className="calendar-link" href="https://calendar.google.com/calendar/render?action=TEMPLATE&text=Darwin%20%26%20Cynthia%27s%20Engagement&dates=20260926T043000Z/20260926T103000Z&details=Join%20us%20for%20our%20engagement%20celebration%20in%20Kochi" target="_blank" rel="noreferrer">Add to calendar <span>＋</span></a>
        </div>
      </section>
      ...
      <section className="finale panel">
        ...
        <div className="finale-copy reveal">
          ...
          <p className="final-names">Darwin <span>&</span> Cynthia</p>
        </div>
      </section>
      <footer><span>D <i>&</i> C</span><p>Made with love for our forever.</p></footer>
    </main>
  );
}
